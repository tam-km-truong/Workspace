...
class Batching:
    ...
    def _create_dustbin(self):
        ...
        ##############################################################################        
        fns_unknown_species = self.clusters['']
        self.pseudoclusters["dustbin"].extend(fns_unknown_species)
        genome_of_unknown_species_count = len(fns_unknown_species)
        genome_count += genome_of_unknown_species_count
        
        self.clusters.pop('',None)
        ...
        print(
            f"Put {genome_count} genomes of {species_count} species into the dustbin, {genome_of_unknown_species_count} genomes of unknown species",
            file=sys.stderr)
        ###############################################################################
