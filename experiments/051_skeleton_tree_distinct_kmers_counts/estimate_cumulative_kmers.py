...
def count_distinct_kmers(input_file, output_file, tmp_dir="experiments/051_skeleton_tree_distinct_kmers_counts/tmp"):
...
def parse_args():
    ...
    parser.add_argument("--tmp", default="tmp", help="Temporary directory for intermediate sketches (default: tmp)")
